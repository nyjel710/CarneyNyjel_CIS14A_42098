// Variables
var hoursWorked = 15; // Total hours worked
...
payCheck = (hoursWorked < overtime)? hoursWorked * payRate:
	(hoursWorked >= overtime && hoursWorked <= tripletime)?
	overtime * payRate + 2 * payRate * (hoursWorked - overtime):
	(hoursWorked > tripletime)? tripletime * payRate + 3 * payRate * (hoursWorked - tripletime);
